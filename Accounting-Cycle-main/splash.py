...
class splashScreen():
    ...
    def splash(self):
        ...
        self.image = Image.open("./images/black.png")
        ...
        canvas.create_text(290,90, text='COMPUTERIZED ACCOUNTING PROJECT', font=("Times New Roman bold",22),fill = 'white')
        canvas.create_text(290,160, text=' Course Instructor: Sir Farhan Ahmed', font=("Times 10 bold",18),fill = 'white')
        canvas.create_text(280,220, text='Group Members:', font=("Times 10 bold",20),fill = 'white')
        canvas.create_text(300,260, text='Name\t\t  Seat Number', font=("Times 10 bold",19),fill = 'white') 
        canvas.create_text(180,330, text='Abu Ubaida \nMuhammad Hammad', font=("Times 10 bold",16),fill = 'white')
        canvas.create_text(420,330, text='B20103007 \nB20103039', font=("Times 10 bold",15),fill = 'white')
